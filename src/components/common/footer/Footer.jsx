...
export function Footer({ iconSocialMedia, itemText, iconMethod }) {
  return (
    <footer class="container">
      <div>
        ...
        <div class="Footer-container">
          <div class="Footer-container-locales">
            <div class="Footer-container-locales-item-top">
              ...
              <div class="Footer-container-item">
                <ul>
                  ...
                  <li>
                    <a href="">Terminos y condiciones de promociones</a>
                  </li>
                  <li>
            ...
            <div class="Footer-container-locales-logo">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="163.686"
                height="56.966"
          ...
          <div class="Footer-container-paymentMethod">
            <div class="Footer-container-paymentMethod-text">
              <p>Formas de pago</p>
            </div>
            <div class="Footer-container-paymentMethod-icon">
              <div class="Footer-container-paymentMethod-icon-method">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="72.972"
                  height="39.692"
              ...
              <div class="Footer-container-paymentMethod-icon-safety">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="162.527"
                  height="33.86"
              ...
              <div class="Footer-container-paymentMethod-icon-comprobante">
                <a href="#" class="button-comprobante">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                    height="24"
          ...
          <div class="Footer-container-news">
            <div>
              ...
              <div class="Footer-container-news-mail">
                <input placeholder="tu correo" />
                <button class="button-send">Enviar</button>
              </div>
              <div class="Footer-container-news-checkbox">
                <input type="checkbox" />
                <label>
                  he leido y revisado los <a>terminos y condiciones</a>
                </label>
              </div>
            </div>
          </div>
