         ...
         <div className="footer container">
                ...
                <div className="Redes-sociales">
                    <div className="Redes-sociales-icon">
                           <a href="https://www.facebook.com/bembos/" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="92.384" height="92.371" viewBox="0 0 92.384 92.371">
                                            <path d="M46.191 0a46.185 46.185 0 1 0 46.193 46.187A46.191 46.191 0 0 0 46.191 0zm14.608 26.456s-4.425-.024-6.22-.024c-3.525 0-3.284 1.372-3.284 5.709v3.215h9.5l-1.71 11.225h-7.793v30.175h-13.2V46.583h-6.5V35.356h6.5V26.32a10.678 10.678 0 0 1 3.992-8.123 13.4 13.4 0 0 1 8.043-2.58l10.672.018z" fill="#fff"></path>
                                </svg>
                            </a> 
                            <a  href="https://www.youtube.com/user/BembosCanal" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="90.864" height="90.86" viewBox="0 0 90.864 90.86">
                                    <path d="M45.43 0a45.43 45.43 0 1 0 45.435 45.434A45.432 45.432 0 0 0 45.43 0zm28.742 59.867a7.525 7.525 0 0 1-5.3 5.306c-4.675 1.248-23.436 1.248-23.436 1.248s-18.75 0-23.436-1.248a7.532 7.532 0 0 1-5.306-5.306c-1.248-4.675-1.248-14.437-1.248-14.437s0-9.762 1.248-14.437A7.528 7.528 0 0 1 22 25.687c4.686-1.25 23.436-1.25 23.436-1.25s18.761 0 23.436 1.25a7.522 7.522 0 0 1 5.3 5.306c1.25 4.675 1.25 14.438 1.25 14.438s-.004 9.761-1.25 14.436z" fill="#fff"></path>
                                    <path d="m39.44 54.428 15.582-9-15.582-9z" fill="#fff"></path>
                                </svg>
                            </a>
                            <a href="https://x.com/i/flow/login?redirect_after_login=%2FBembosOficial" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="90.867" height="90.86" viewBox="0 0 90.867 90.86">
                                    <path d="M45.437 0a45.43 45.43 0 1 0 45.43 45.434A45.435 45.435 0 0 0 45.437 0zm21.6 34.351c.015.482.027.954.027 1.438 0 14.725-11.2 31.712-31.709 31.712a31.5 31.5 0 0 1-17.081-5.007 22.405 22.405 0 0 0 16.5-4.618 11.159 11.159 0 0 1-10.413-7.731 11.356 11.356 0 0 0 2.1.2 11.112 11.112 0 0 0 2.929-.389 11.163 11.163 0 0 1-8.935-10.937v-.137a11.052 11.052 0 0 0 5.047 1.4 11.157 11.157 0 0 1-3.45-14.88 31.631 31.631 0 0 0 22.969 11.641 11.164 11.164 0 0 1 10.86-13.683 11.076 11.076 0 0 1 8.131 3.525 22.348 22.348 0 0 0 7.076-2.715 11.194 11.194 0 0 1-4.9 6.173 22.475 22.475 0 0 0 6.4-1.757 22.8 22.8 0 0 1-5.549 5.762z" fill="#fff"></path>
                                </svg>
                            </a>
                           
                            <a href="https://www.instagram.com/bembosoficial/?hl=es-la" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="89.047" height="89.047" viewBox="0 0 89.047 89.047">
                                <g fill="#fff">
